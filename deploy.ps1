...
Invoke-SSH "mkdir -p ${RemoteStaging}/css ${RemoteStaging}/js ${RemoteStaging}/daemon"

# 2. Upload files to /tmp staging directory
Write-Host "[2/4] Uploading core files, CSS, JS, and daemon modules..." -ForegroundColor Yellow
...
Send-SSHFile "$LocalDir\js\config.js" "${RemoteStaging}/js/config.js"
Send-SSHFile "$LocalDir\js\audio.js" "${RemoteStaging}/js/audio.js"
Send-SSHFile "$LocalDir\js\globe.js" "${RemoteStaging}/js/globe.js"
Send-SSHFile "$LocalDir\js\telemetry.js" "${RemoteStaging}/js/telemetry.js"
Send-SSHFile "$LocalDir\js\main.js" "${RemoteStaging}/js/main.js"
